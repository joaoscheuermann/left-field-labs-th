...
const SvgAt = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g clipPath="url(#AT_svg__a)">
      ...
      <path
        fill="#D80027"
        d="M12 24c5.16 0 9.559-3.257 11.254-7.827H.747C2.443 20.743 6.841 24 12.001 24M12 0C6.84 0 2.442 3.257.747 7.826h22.507C21.558 3.256 17.16 0 12 0"
      />
    </g>
    <defs>
